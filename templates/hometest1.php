...
<!--Header-->
				...
				<div class="row" >
					<div class="col-md-10 col-md-offset-1 text-center">
						<ul class="hero-area-tree">
							<li><a href="http://localhost/CAREER-GUIDANCE-SYSTEM-MAIN/main.php">Services</a></li>
							<li><a href="http://localhost/CAREER-GUIDANCE-SYSTEM-MAIN/templates/hometest1.php">Career Prediction</a></li>
						</ul>
 ...
 <!-- Icons font CSS-->
	<link rel="stylesheet" href="../static/vendor/mdi-font/css/material-design-iconic-font.min.css">
	<link rel="stylesheet" href="../static/vendor/font-awesome-4.7/css/font-awesome.min.css">
	<link rel="stylesheet" href="../static/css/range.scss">
	  <!-- Vendor CSS-->
	<link rel="stylesheet" href="../static/vendor/select2/select2.min.css">
	<link rel="stylesheet" href="../static/vendor/datepicker/daterangepicker.css">
	  <!-- Main CSS-->
...
<body>
    <div class="page-wrapper p-t-45 p-b-50" style="background-color: #9b87cad4;">
        <div class="wrapper wrapper--w790">
            <div class="card card-5">
						...
						<div class="form-group row">
							...
							<select class="form-select form-control" required aria-label="select example" name="rate_Database Fundamentals">
								 ...
								 <option value="1">Not Interested</option>
									...
									<option	on value="5">Average</option>
                ...
                <!-- <center><button class="btn btn--radius-2 btn--red" type="submit" style="margin-top:10px">Discover Yourself!</button></center> -->
                <center><a href="http://localhost/CAREER-GUIDANCE-SYSTEM-MAIN/templates/testafter1.php"><button class="btn btn--radius-2 btn--red" style="margin-top:10px">Discover Yourself!</button></a></center>
			...
			<div class="container">
				...
				<div class="row">
					...
					<div class="col-md-6">
						<div class="footer-logo">
							<a class="logo" style="font-size: 30px; color: white;" href="main.php">Career.io</a>
						</div>
					</div>
					<!-- footer logo -->
				...
				<div id="bottom-footer" class="row">
					...
					<div class="col-md-8 col-md-pull-4">
						<div class="footer-copyright" style="color: white; font-size:15px;">
